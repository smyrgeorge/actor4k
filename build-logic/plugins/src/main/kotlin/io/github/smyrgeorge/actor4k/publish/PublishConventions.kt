...
class PublishConventions : Plugin<Project> {
    ...
    private val descriptions: Map<String, String> = mapOf(
        ...
        "actor4k-rt-kmp" to "A small actor system written in kotlin using Coroutines (kotlinx.coroutines).",
        "actor4k-rt-jvm" to "A small actor system written in kotlin using Coroutines (kotlinx.coroutines).",
    )
