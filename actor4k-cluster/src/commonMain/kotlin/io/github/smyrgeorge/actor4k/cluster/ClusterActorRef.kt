...
class ClusterActorRef(
    ...
    override suspend fun shutdown() {
        service.shutdown(address)
    }

    /**
     * Provides a string representation of the `ClusterActorRef` instance.
     *
     * @return A string that includes the class name and the node and address information in the format "ClusterRef(node//address)".
     */
    override fun toString(): String = "ClusterRef($node//$address)"
}