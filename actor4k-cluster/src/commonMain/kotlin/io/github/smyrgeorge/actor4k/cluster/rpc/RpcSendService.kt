...
class RpcSendService(
     ...
     * @throws IllegalStateException if the response ID does not match the request ID.
     */
    suspend fun tell(addr: Address, msg: ActorProtocol): Result<Response> = runCatching {
     ...
     * @throws IllegalStateException if the response ID does not match the request ID.
     */
    suspend fun ask(addr: Address, msg: ActorProtocol.Message<*>): Result<Response> = runCatching {
